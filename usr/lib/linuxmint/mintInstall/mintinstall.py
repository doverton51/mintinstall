    ...
    def on_button_clicked(self):        
        ...
        if package is not None:                
            if package.pkg.is_installed:
                result = subprocess.check_output(["/usr/lib/linuxmint/mintInstall/aptd_client.py", "remove", package.pkg.name])
            else:
                result = subprocess.check_output(["/usr/lib/linuxmint/mintInstall/aptd_client.py", "install", package.pkg.name])
